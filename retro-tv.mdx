---
title: "RetroTV for MeowKit-S3 | Wireless PC Display"
sidebarTitle: "RetroTV"
description: "Turn MeowKit-S3 into a tiny wireless Windows display with RetroTV and ScreenShotSender. Follow setup, network, display, and troubleshooting steps."
og:title: "RetroTV for MeowKit-S3 | Wireless PC Display"
og:url: "https://docs.meowkit.cc/retro-tv"
keywords:
  - "MeowKit RetroTV"
  - "ESP32 ScreenShotReceiver"
  - "wireless PC display"
  - "MeowKit Windows screen"
  - "ScreenShotSender"
---

![RetroTV wireless PC display running on MeowKit-S3](/images/retro-tv.webp "Retro Tv")
